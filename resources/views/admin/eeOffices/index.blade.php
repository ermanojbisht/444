...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-EeOffice">
                <thead>
                <tr>
                    <th width="10">
                    </th>
    ...
    <script>
        $(function () {
            ...
            let dtOverrideGlobals = {
                    ...
                    retrieve: true,
                    aaSorting: [],
                    ajax: "{{ route('admin.ee-offices.index') }}",
                    columns: [
            ...
            let table = $('.datatable-EeOffice').DataTable(dtOverrideGlobals);
