	...
	<div class="card-body">
		<div class="form-group">
			<div class="row">
				...
				<div class="col-md-12">
					<table class="table">
						...
						<tr>
							<td>
								<p class=" fw-bold "> ACR Type :-</p>
							</td>
							<td>
								<span class="data"> {{$acr->type->description }} </span>
							</td>
						</tr>
					</table>
				</div>
			...
			<div class="row">
				<div class="col-md-12 ">
					@if ($acr->is_active)
					<div style="width:100%" class=" text-center bg-danger text-white fw-bold h3"> This ACR has been
						Rejected </div>
					@endif
				</div>
			</div>
