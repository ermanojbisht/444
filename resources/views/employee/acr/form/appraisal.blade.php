...
<div class="card">
	<form class="form-horizontal" method="POST" action="{{route('acr.form.storeAppraisal1')}}">
						...
						<tr>
							...
							<td class="text-end">
								...
								<input class="form-control form-control-sm text-end reportingPersonalNo" type="number"
									...
									max="{{$personal_attribute->max_marks}}" @if($personal_attribute->reporting_marks)
		...
		<div class="card-body border border-2 border-danger">
			...
			<input type="hidden" name="final_marks" value="{{$net_marksA+ $reporting_marksB - $reporting_marksC}}"> --}}
			<table class="table table-bordered table-sm">
				<thead>
					<tr class="text-center align-middle">
						<th>Description</th>
