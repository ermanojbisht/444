				...
				<table class="table table-bordered table-sm">
					...
					<tbody>
						...
						<tr class="bg-danger fw-bold" id="exceptional_row">
							<td></td>
							<td class="text-end">User Declare all Parameters as not Applicable Reprting Officer may Give Number here </td>
			...
			<table class="table table-bordered table-sm">
				...
				<tbody>
					...
					<tr class="bg-light fw-bold fs-5">
						...
						<td class="text-center" id="Nettotal">{{$net_marksA+ $reporting_marksB - $reporting_marksC}}
						</td>
					</tr>
				</tbody>
			</table>
...
<script type="text/javascript">
	$(window).on('load', function() {
	    if({{$positive_factor > 0}}){
	    	$("#exceptional_row").hide();
	    }else{
	    	$("#exceptional_row").show();
	    }
	});
</script>
<script type="text/javascript">
