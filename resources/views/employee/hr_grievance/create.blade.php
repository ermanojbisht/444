...
<form action="{{ route('employee.hr_grivance.store') }}" method="POST"
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label for="grivance_type_id" class="form-label required"> Grievance Type ( शिकायत का प्रकार)   </label>
                    </div>
                    <div class="col-md-6">
                        <select class="form-select" id="grivance_type_id" name="grivance_type_id" required>
                            <option value=""> Select Grievance Type </option>
                            @foreach($grivanceTypes as $grivance )
                            <option value="{{$grivance->id}}" {{ old('grivance_type_id')==$grivance->id ? 'selected' :
                                '' }}> {{$grivance->name}}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label for="description" class="form-label required "> Description of Grievance ( शिकायत का संछिप्त सार)   </label>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label for="is_document_upload" class="form-label required"> Do You want to Upload Document ( डॉक्यूमेंट अपलोड करने हेतु  )   </label>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="box-footer justify-content-between">
                                <input type="submit" confirm("Press a button!"); id="btnAddRegDetails" class="btn btn-primary" 
                                    value = "Add Grievance ( शिकायत / मांग / सुझाव दर्ज करे)"  
                                </button>
                ...
                <div class="text-medium-emphasis small">
                    ...
                    ( शिकायत जमा करने के, केवल {{config('site.backdate.hrGrivance.allowedno')}} दिनों तक ही सुधर किया जा सकेगा | )<br />
