...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function update($id, $data = [], $privacyStatus = 'public')
        {
                        /** @var \Dawson\Youtube\Youtube $instance */
                        return $instance->update($id, $data, $privacyStatus);
        }
                    /**
     ...
     */ 
        class LaravelPassportViewsFacade {
...
namespace  { 
            ...
            class LaravelPassportViews extends \Luigel\LaravelPassportViews\LaravelPassportViewsFacade {}
